...
>((props, ref) => {
  ...
  //       <div
  //         ref={prefixNode}
  //         className=" absolute top-2/4 transform -translate-y-2/4 ltr:left-2.5 rtl:right-2.5"
  //       >
  //         {" "}
  //         {prefix}{" "}
  //       </div>
  ...
  //       <div
  //         ref={suffixNode}
  //         className=" absolute top-2/4 transform -translate-y-2/4 ltr:right-2.5 rtl:left-2.5"
  //       >
  //         {suffix}
  //       </div>
  //     ) : null}
  ...
  const renderAffixInput = (
    <span className={inputWrapperClass} style={{ position: "relative" }}>
      {prefix ? (
        <div
          ref={prefixNode}
          className={`absolute top-2/4 transform -translate-y-2/4 ${
            document.documentElement.dir === "rtl" ? "right-2.5" : "left-2.5"
          }`}
        >
          {prefix}
        </div>
      ...
      {suffix ? (
        <div
          ref={suffixNode}
          className={`absolute top-2/4 transform -translate-y-2/4 ${
            document.documentElement.dir === "rtl" ? "left-2.5" : "right-2.5"
          }`}
        >
          {suffix}
        </div>
