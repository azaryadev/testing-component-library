    ...
    docs: {
      page: () => (
        <>
          <Title />
          <Description>
            The Drawer component is a panel that slides in from the edge of the
            screen. It's commonly used for navigation menus, filters, or
            displaying additional content without leaving the current context.
          </Description>
          <Canvas />
          <Controls />
          {/* <ArgTypes />
