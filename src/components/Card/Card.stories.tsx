    ...
    docs: {
      page: () => (
        <>
          <Title />
          <Description>
            The Card component provides a flexible, customizable container for
            displaying grouped content with optional header and footer sections.
            It can include borders, be clickable, and supports additional
