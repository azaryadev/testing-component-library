    ...
    docs: {
      page: () => (
        <>
          <Title />
          <Description>
            The Checkbox component provides a flexible, accessible checkbox
            element with support for custom classes, controlled/uncontrolled
            states, and optional labels. Use Checkbox.Group to manage multiple
            checkboxes as a group with shared styling, values, and selection
            logic.
          </Description>
          <Canvas />
          <Controls />
